...
public class UserLoginController {
		...
		public ModelAndView validateUser(@ModelAttribute("user") User userObj) {
			...
			ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("com/mahesh/bean.xml");
			UserDao userdao = (UserDao) ((AbstractApplicationContext) context).getBean("udao");
